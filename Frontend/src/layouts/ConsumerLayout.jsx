...
export default function ConsumerLayout() {
    ...
    return (
        <div className="flex h-screen bg-[#F0FDF4] overflow-hidden">
            ...
            {/* Sidebar */}
            <div className={`
                fixed lg:static inset-y-0 left-0 z-50 transition-transform duration-300 h-screen overflow-y-auto shrink-0
            ...
            <div className="flex-1 min-w-0 flex flex-col h-screen">
                ...
                <div className="lg:hidden bg-white border-b border-[#D1FAE5] px-4 py-3 flex items-center gap-3 shrink-0">
                    ...
                    <span className="font-semibold text-[#064E3B]" style={{ fontFamily: "'Playfair Display SC', serif" }}>FoodSave</span>
                </div>
